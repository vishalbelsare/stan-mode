...
> [!WARNING]
> `stan-mode` has been unmaintained for some time. For a more up-to-date Stan editing experience, check out [`stan-ts-mode`](https://github.com/WardBrian/stan-ts-mode)
